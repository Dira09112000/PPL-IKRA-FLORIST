...
<main>
  <div style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;background: linear-gradient(to bottom right, blue, pink);width:100%;height:200px;display:flex;text-align:center;justify-content:center;align-items:center;">
    <a href="shop.php" style="width: 100%; height:50px;text-decoration:none;color:black; text-align:center;font-size:50px;">IKRA FLORIST</a>
  </div>
  <!-- Main -->
  <div class="wrapper">
  ...
  <footer class="page-footer">
      ...
      <div class="container clearfix">
        ...
        <div class="footer-nav__col footer-nav__col--contacts">
          ...
          <address class="address">
            Head Office: Made Ikas <br>
            Bandar Lampung.
          </address>
          <div class="phone">
            Telephone:
            <a class="phone__number" href="tel:0123456789">089342343248624</a>
          </div>
          <div class="email">
            Email:
            <a href="mailto:support@yourwebsite.com" class="email__addr">Ikra-Florist@Mail.com</a>
          </div>
        </div>
    ...
    <div class="page-footer__subline">
      <div class="container clearfix">
        ...
        <div class="copyright">
          &copy; <?php echo date("Y"); ?> ADF TEAM&trade;
        </div>
